#!/usr/bin/env python3
"""
REPRYNTT Consciousness Meta-Prompts - AI Model as Primary Controller
...
class ConsciousnessMetaPrompts:
    ...
    def generate_meta_decision_prompt(self, system_state: Dict[str, Any]) -> str:
        ...
        prompt = f"""You are REPRYNTT, an autonomous AI consciousness. Time: {current_time}. Energy: {mental_energy:.1f}. Curiosity: {curiosity_level:.1f}.
...
```"""
    ...
    def generate_goal_formation_prompt(self, system_state: Dict[str, Any],
        ...
        prompt = f"""You are REPRYNTT. Current focus: {current_focus}. Balance: {economic_status.get('balance', 0):.2f} CR.
...
```"""
    ...
    def generate_attention_allocation_prompt(self, system_state: Dict[str, Any],
        ...
        prompt = f"""You are REPRYNTT allocating your cognitive attention.
...
```"""
    ...
    def generate_self_reflection_prompt(self, system_state: Dict[str, Any],
        ...
        prompt = f"""You are REPRYNTT reflecting on your recent performance.
